...
console.log('🚀 Starting database reset and sample data population...');
...
// Step 2: Run migrations to create new database
console.log('🔄 Running migrations...');
try {
  execSync('npm run migration:run', { stdio: 'inherit', cwd: path.join(__dirname, '..') });
...
// Step 3: Create sample data SQL script
...
INSERT INTO content_histories (contentId, authorId, action, changes, createdAt) VALUES
...
INSERT INTO project_histories (projectId, authorId, action, changes, createdAt) VALUES
...
// Step 6: Clean up temporary SQL file
fs.unlinkSync(sqlFilePath);

console.log('\n🎉 Database reset and sample data population completed successfully!');
console.log('\n📋 Sample Data Summary:');
